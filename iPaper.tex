...
were extracted extracted with R-packages {\tt
  raster}\citep{Hijmans2015}.
...
\gls{LWSC} fluctuations were more regular in detrended chronologies
than in original chronologies regardless ubication of the samples.
...
Responses of the \gls{TRW} to monthly fluctuations of climate were
...
were slightly stronger in estarn- than in north-central edges of study
...
of climate were different in the two edges of the study site. In north
central Spain, the \gls{LWSC} significantly responded to summer
temperatures and no conclusive relationships were evidenced between
the stable isotope and the temperature in the othes seasons.
